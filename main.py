...
st.set_page_config(page_title="Simple Financial Indicator Dashboard", page_icon="💰", layout="wide")
...
def main():
    ...
    uploaded_file = st.file_uploader("Please upload your transaction CSV file", type = ["csv"])
